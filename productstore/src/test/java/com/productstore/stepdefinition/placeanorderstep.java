...
//@TC_03_order
	...
	public void the_user_filling_the_name_as_country_as_city_as_creditcard_as_month_as_year_as_details(String name,String country, String city, String creditcard, String month, String year) throws InterruptedException {
		// Write code here that turns the phrase above into concrete actions
		Thread.sleep(2000);
		productorder.add();
		Thread.sleep(2000);
